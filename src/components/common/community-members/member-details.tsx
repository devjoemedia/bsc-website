...
export function MemberDetails({ member, isOpen, setIsOpen }: { member: CommunityMember | null, isOpen: boolean, setIsOpen: (isOpen: boolean) => void }) {
      ...
      <DrawerContent className="rounded-none!">
        ...
        <DrawerFooter className="flex flex-row border-t bg-background px-4 py-4">
          <DrawerClose className="flex-1" asChild>
            <Button variant="default" className=" text-white py-5 cursor-pointer">Close</Button>
          </DrawerClose>
        </DrawerFooter>
      </DrawerContent>
    </Drawer>
